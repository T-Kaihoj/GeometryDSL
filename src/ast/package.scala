...
package ast {
    ...
    sealed case class MethodDefinition(name: String, retType: Type, params: List[Expression], block: Block) extends ProgramEntity
    ...
    case class Operation(operator: Operator, LeftOperands:Expression, rightOperands:Expression) extends Expression
